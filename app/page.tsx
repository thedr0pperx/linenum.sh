    ...
    <main className="min-h-screen relative">
      ...
      <footer className="container mx-auto px-4 sm:px-6 py-8 sm:py-12 mt-12 sm:mt-16 border-t-2 border-matrix-green/30">
        <div className="text-center space-y-3 sm:space-y-4">
          ...
          <div className="pt-3 sm:pt-4 border-t border-gray-300 mt-3 sm:mt-4">
            <a
              href="mailto:hello@b7z.tech"
              className="inline-flex items-center gap-2 text-gray-700 hover:text-matrix-green font-mono text-xs sm:text-sm transition-colors"
            >
              <svg className="w-4 h-4 sm:w-5 sm:h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
              </svg>
              <span>hello@b7z.tech</span>
            </a>
          </div>
        </div>
      </footer>
